...
const App = () => {
  ...
  const onFocusedRowChanging = useCallback(
    async (e: DataGridTypes.FocusedRowChangingEvent) => {
  ...
  const onFocusedRowChanged = useCallback(
    (e: DataGridTypes.FocusedRowChangedEvent) => {
      ...
      // scrollToRow 대신 navigateToRow 사용
      setTimeout(() => {
        e.component.navigateToRow(e.component.option("focusedRowKey"));
      }, 100);
    },
    []
  );

  const onAutoNavigateToFocusedRowChanged = useCallback(
  ...
  return (
    <div>
      <DataGrid
        ...
        showBorders={true}
      >
        <Scrolling preloadEnabled={true} key={"scrolling"} />
